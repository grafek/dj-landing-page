...
const AboutPage = () => {
  ...
  return (
    <PageWrapper className="flex flex-col flex-wrap text-justify ">
      <div className="flex flex-col items-start gap-4 lg:flex-row lg:items-center xl:w-2/3">
        <div className="mx-auto flex flex-col items-center">
          ...
          <Link
            href={igLink}
            target="_blank"
            className="decoration-purple-primary hover:text-purple-primary mx-auto text-sm font-light italic underline underline-offset-4 transition-colors duration-300"
          >
            @jackdahaus
          </Link>
        </div>

        <div className="flex flex-col gap-4 pt-4 sm:px-12 md:px-24">
          <p>
            Hey there! I am{" "}
            ...
            House music has left a big mark on my soul since the beginning,
            although I also like to play it fast (trance, techno).
          </p>
          <div>
            Over the past two years, my passion for DJing has been an
            exhilarating journey of growth and exploration.
            <div className="pt-2">
              During this time I...:
              <ul>
                <li>
                  ...
                  <Link
                    href={
                      "https://www.instagram.com/p/C7hhcgLoXSa/?img_index=1"
                    }
                    target="_blank"
                    className="decoration-purple-primary hover:text-purple-primary w-fit font-semibold italic underline underline-offset-4 transition-colors duration-300"
                  >
                    Wyspa Tamka
                  </Link>
                  , outdoor haus stage.
